 ...
 */
final class Version20191117112947 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE contractor_settings (id INT AUTO_INCREMENT NOT NULL, contractor_id INT NOT NULL, monday VARCHAR(255) NOT NULL COMMENT \'(DC2Type:dateinterval)\', tuesday VARCHAR(255) NOT NULL COMMENT \'(DC2Type:dateinterval)\', wednesday VARCHAR(255) NOT NULL COMMENT \'(DC2Type:dateinterval)\', thursday VARCHAR(255) NOT NULL COMMENT \'(DC2Type:dateinterval)\', friday VARCHAR(255) NOT NULL COMMENT \'(DC2Type:dateinterval)\', saturday VARCHAR(255) NOT NULL COMMENT \'(DC2Type:dateinterval)\', sunday VARCHAR(255) NOT NULL COMMENT \'(DC2Type:dateinterval)\', visit_duration TIME NOT NULL, UNIQUE INDEX UNIQ_D9126EDB0265DC7 (contractor_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
