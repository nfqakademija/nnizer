 ...
 */
final class Version20191214122046 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE contractor CHANGE services_id services_id INT DEFAULT NULL, CHANGE roles roles JSON NOT NULL, CHANGE phone_number phone_number VARCHAR(16) DEFAULT NULL, CHANGE title title VARCHAR(32) DEFAULT NULL, CHANGE address address VARCHAR(64) DEFAULT NULL, CHANGE facebook facebook VARCHAR(32) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE service_type_contractor (service_type_id INT NOT NULL, contractor_id INT NOT NULL, INDEX IDX_7C79742EB0265DC7 (contractor_id), INDEX IDX_7C79742EAC8DE0F (service_type_id), PRIMARY KEY(service_type_id, contractor_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
