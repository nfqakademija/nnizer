 ...
 */
final class Version20191130122757 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX idx_key ON contractor (verification_key)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX idx_key ON contractor');
