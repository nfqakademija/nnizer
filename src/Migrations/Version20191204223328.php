 ...
 */
final class Version20191204223328 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE cover_photo ADD created_at DATETIME NOT NULL, ADD updated_at DATETIME NOT NULL');
        $this->addSql('ALTER TABLE profile_photo ADD created_at DATETIME NOT NULL, ADD updated_at DATETIME NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE cover_photo DROP created_at, DROP updated_at');
        $this->addSql('ALTER TABLE profile_photo DROP created_at, DROP updated_at');
